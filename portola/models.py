...
class Project(models.Model):
    ...
    number = models.CharField(db_index=True, max_length=16, blank=False, null=False,unique=True)
...
class DocumentTemplate(models.Model):
    ...
    document_title = models.CharField(max_length=150, blank=True, null=True)
    ...
    factory_witness_date=models.DateField(blank=True, null=True)
    technology_tags = models.ManyToManyField('TechnologyTag',related_name='documenttemeplate')
...
class ProjectTemplate(models.Model):
    ...
    number = models.CharField(db_index=True, max_length=16,unique=True, blank=False, null=False)
    status = models.CharField(db_index=True, choices=PROJECT_STATUS, default='ACTIVE', max_length=100)
    salesforce_id = models.CharField(max_length=10, blank=True, null=True)
    name = models.CharField(max_length=32, blank=True, null=True)
    contract_signature = models.DateField(null=True, blank=False)
    ...
    active=models.BooleanField(null=True,blank=True,default=True)
    # documents = models.ManyToManyField('Documents',related_name='projects')
    # followers = models.ManyToManyField('auth.User',related_name='projectsfollowing')
...
class EntityTemplate(models.Model):
    ...
    website = models.CharField(max_length=255, blank=True, default='')
    country = models.CharField(max_length=100, blank=True, default='')
    # followers = models.ManyToManyField('auth.User',related_name='entitiesfollowing')
    company_type = models.CharField(choices=CO_ENTITY_TYPES, default="MFG", max_length=100)
    public = models.BooleanField(default=True, blank=False, null=False)
    active=models.BooleanField(null=True,blank=True,default=True)
    # any other contact info?
