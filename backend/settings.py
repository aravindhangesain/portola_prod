...
ALLOWED_HOSTS = [os.environ['WEBSITE_SITE_NAME'] + '.azurewebsites.net',
                 '127.0.0.1'] if 'WEBSITE_SITE_NAME' in os.environ else ['localhost', '127.0.0.1', '[::1]']
...
DATA_UPLOAD_MAX_MEMORY_SIZE = 5120000000000000000
REST_FRAMEWORK = {
    'HTML_SELECT_CUTOFF': 5000,
...
if 'WEBSITE_SITE_NAME' in os.environ:
    ...
    AZURE_ACCOUNT_NAME = "portalstore1"
